...
Izuzev trećeg bajta sa LE\footnote{\textit{Low Energy}} i BR/EDR\footnote{\textit{Bluetooth Radio/Enhanced Data Rate}} zastavicama prvih devet bajtova svakog paketa su jednaki kod svakog odašiljača. 
