...
\begin{abstract}
Positioning technologies that receive signals from distant satellites (such as GPS) aren't suitable indoors. 
Because of that the indoor navigation and positioning problem requires a new and different approach.
With the adoption of the Bluetooth 4.0 specification and the Bluetooth Low Energy technology, a large number of cheap Bluetooth Smart Ready devices has been manufactured that could be used for solving the indoor positioning problem. 
